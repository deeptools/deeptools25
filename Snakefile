...
rule plot_all_benchmarks:
    ...
    output:
        bamCoverage_time_plot = "output/bamCoverage_" + ORGANISM + "_bs" + str(BINSIZE) + "_plot_time.png",
        bamCoverage_mem_plot = "output/bamCoverage_" + ORGANISM + "_bs" + str(BINSIZE) + "_plot_mem.png",
        bamCompare_time_plot = "output/bamCompare_" + ORGANISM + "_bs" + str(BINSIZE) + "_plot_time.png",
        bamCompare_mem_plot = "output/bamCompare_" + ORGANISM + "_bs" + str(BINSIZE) + "_plot_mem.png"
    shell:
        """
        ...
        python3 plot.py output/bamCompare_{ORGANISM}_bs{BINSIZE}_plot \
